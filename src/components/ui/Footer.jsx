...
export default function Footer({ className = '', shadow = false, rowPadding = 'py-[21px]' }) {
  const { t } = useLanguage()
  ...
  return (
    <div className={className}>
      ...
      <div className={`grid grid-cols-2 items-center gap-y-3 ${rowPadding} font-neue-haas-display text-[11px] uppercase tracking-[0.24em] text-bone-porcelain/70 sm:grid-cols-[1fr_auto_1fr] sm:gap-y-0`}>
